...
plt.scatter(df_main["first_release_date"],
            df_main["critic_rating_value"],
            color="blue",
            label="critic Ratings")

plt.scatter(df_main["first_release_date"],
            df_main["user_rating_value"],
            color="red",
            label="user Ratings")
...
df_main = pd.read_csv("game-ratings-by-top-10-genres")
...
df_hype = df_hype.rename(columns={"hype _count": "total_hypes"})
...
df_main = pd.read_csv("game-ratings-by-top-10-platforms")
